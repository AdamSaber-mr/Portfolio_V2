...
export const PROJECTS: Project[] = [
  { name: 'RapidCars', cat: 'front', year: '2024', ratio: '4/3', color: '#1b1d22', stack: 'React · TypeScript · Vite',
  ...
  { name: 'Nike Business Anatomy', cat: 'data', year: '2025', ratio: '1/1', color: '#0e1b2b', stack: 'React · D3 · Chart.js',
  ...
  { name: 'Luxora', cat: 'front', year: '2025', ratio: '3/4', color: '#2f3a2c', stack: 'Next.js · React · TS',
  ...
  { name: 'Yume Ramen', cat: 'full', year: '2025', ratio: '4/3', color: '#3a1f22', stack: 'PHP · MySQL · Python',
  ...
  { name: 'CookUp', cat: 'full', year: '2025', ratio: '1/1', color: '#243027', stack: 'PHP · MySQL · CRUD',
  ...
  { name: 'Portfolio v1', cat: 'front', year: '2024', ratio: '3/4', color: '#26222c', stack: 'HTML · CSS · JS',
...
export interface LocProject {
  name: string; year: string; ratio: string; color: string; stack: string;
  kind: string; blurb: string; cat: Cat;
}

export function loc(p: Project, lang: Lang): LocProject {
  return { name: p.name, year: p.year, ratio: p.ratio, color: p.color, stack: p.stack, kind: p.kind[lang], blurb: p.blurb[lang], cat: p.cat };
}
